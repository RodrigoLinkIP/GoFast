...
class MYPDF extends TCPDF
{
    ...
    {
        // Logo
        $image_file = K_PATH_IMAGES . 'darkgofast.png';
    ...
    protected $customPageSize = array(100, 150);  // Ajusta los valores de ancho y alto según tus necesidades
...
$pdf->SetLeftMargin($pdf->GetX() + 10); // Mueve la posición horizontal hacia la derecha en 10 unidades
$pdf->SetY($pdf->GetY() + 30); // Mueve la posición vertical hacia abajo en 20 unidades

$code128X = 100; // Tamaño horizontal del código de barras
$code128H = 15; // Tamaño vertical del código de barras
$code128XPos = 35; // Posición horizontal del código de barras
$code128YPos = 90; // Posición vertical del código de barras
...
$contenidoCelda = "
    ...
    <p><strong>Barcode: </strong>{$codigo_barras}</p>
";
...
$pdf->write1DBarcode($codigo_barras, 'C128', $code128XPos, $code128YPos, $code128X, $code128H, 0.4);
