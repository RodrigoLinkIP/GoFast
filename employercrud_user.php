...
if (isset($_GET['delete'])) {
  ...
  if (pg_num_rows($result) > 0) {
    ...
    if (pg_query($conn, $sql)) {
      header('location:admincrud_user.php');
    }
  }
}
?>
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?php echo $_SESSION['usuario'] ?>'s employees</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sql = "select * from usuario where employerboss = '". $checku ."'";
                      $result = pg_query($conn, $sql);
                      ...
                      ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <a class="btn btn-danger" href="hirenott.php?idusuario2=<?php echo $row['idusuario']; ?>">Fire this driver! <i class="fa fa-eraser"></i></a>
