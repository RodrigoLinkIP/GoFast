                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <?php
                        $querys = "SELECT * FROM usuario";
                        $res = pg_query($conn, $querys);
                        $rows = pg_fetch_array($res);
                        $idusuario = $rows["idusuario"];

                        $query = "SELECT barcode FROM usuario WHERE idusuario =" . $idusuario;
                        ...
                        $rowx = pg_fetch_assoc($resultado);
                        $codigoBarras = $rowx["barcode"];
                        ...
                        <td>
                          <a href="pdfcarnet.php?idusuario=<?php echo $row['idusuario'] ?>" class="btn btn-info"><i class="fa fa-id-card"></i></a>
