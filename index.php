  ...
  <script type="text/javascript" src="https://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit2"></script>
	...
	<div id="body">
		<div>
			<ul id="navigation">
				<li>
					<a href="aboutus.php" class="link2">About us</a>
				</li>
				<li>
			...
			<div id="home" class="container">
				<h1><span>WELCOME TO GOFAST</span></h1>
				<h2>A powerful tool for travelers and bus drivers alike.</h2>
				<div class="section">
					<a href="aboutus.php">Learn More<span>Click Here</span></a>
				</div>
			</div>
		</div>
	</div>
