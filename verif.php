...
<section>
  ...
  <script type="text/javascript" src="https://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit2"></script>
    ...
    <a class="nav-link d-flex align-items-center" onclick="doGTranslate('es'); return false;" href="#" id="navbarDropdownMenuHome" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
        ...
        <div class="text">
            <a>We need to know if your e-mail address is a valid one, we sent you a code to your inbox, insert it below.</a>
        </div>
        <form action="verif.php" method="post">
            <div class="input-box">
                <input type="number" name="code" placeholder="Verification code" id="code" required>
            </div>
