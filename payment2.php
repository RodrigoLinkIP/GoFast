  ...
  <div class="wrapper">
    ...
    if (pg_num_rows($result)) {
      while ($row = pg_fetch_assoc($result)) {
        ...
        $thiscode = $row['barcode'];
      }
    }
    ?>
    <div class="text">
      <a>Paying as <?php echo $thisuname ?></a>
    </div>
    <form action="payment2.php" method="post">
      <div class="input-box">
        <input type="text" name="route" placeholder="Route" id="last-barcode" value="<?php echo $routename ?>" readonly>
      </div>
      <div class="input-box">
        <input type="text" name="last-barcode" placeholder="ID" id="last-barcode" value="<?php echo $thiscode ?>" readonly>
      </div>

      <div class="input-box button">
        <input type="Submit" name="subs" value="Go to pay">
