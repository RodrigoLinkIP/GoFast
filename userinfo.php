...
<body>
        ...
        <div class="row">
          <div class="col-sm-3"><!--left col-->
            ...
            <div class="text-center">
              <img src="<?php echo $upload_dir . $row['images']; ?>" height="200" width="200" class="avatar img-circle" style="background-color: white;">
            </div>
            </hr><br>
          </div><!--/col-3-->
          <div class="col-sm-9">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="home">
                <hr>
                <form class="form" method="post" action="userinfo.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-xs-6">
                      ...
                      <input name="submit" type="submit" href="userinfo_upload.php?idusuario=<?php echo $row['idusuario'] ?>" value="Submit and update" class="btn btn-primary">
                  ...
                  <div class="form-group">
                    <div class="col-xs-6">
                      <a href="redirgal.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Go back</a>
                    </div>
                  </div>
                  <!--<div class="form-group">
                                        <div class="col-xs-12">
  ...
  <div class="card-body">
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        <?php
        $sql = "select * from payment where sender = '" . $unamet . "'";
        $result = pg_query($conn, $sql);
        if (pg_num_rows($result)) {
          while ($row = pg_fetch_assoc($result)) {
        ?>
