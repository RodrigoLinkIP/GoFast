      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a class="nav-link">
                <a href="drivercrud.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Check the routes owned by your company</p>
                </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link">
                <a href="drivercrud_payments.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Payments made to your company</p>
                </a>
            </li>
          </ul>
        </li>
