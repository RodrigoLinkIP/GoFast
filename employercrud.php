<?php
require_once('db.php');
include('addemployer.php');
$upload_dir = 'photos/';
require_once('vendor/autoload.php');
include('removeowners.php');
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sql = "select * from routes where rowner = '". $checku ."'";
                      $result = pg_query($conn, $sql);
                      ...
                      ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <a class="btn btn-danger" href="removeowners.php?id2=<?php echo $row['id']; ?>"><i class="fa fa-eraser"></i></a>
