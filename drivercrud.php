...
<body class="hold-transition sidebar-mini sidebar-closed sidebar-collapse">
  <div class="wrapper">
    ...
    <?php require_once('asidedriver.php'); ?>
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Routes owned by <?php echo $_SESSION['usuario'] ?>'s employer</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $checku = $_SESSION['usuario'];
                      $desql = "select * from usuario where username = '". $checku ."'";
                      $deresult = pg_query($conn, $desql);
                      $derow = pg_fetch_assoc($deresult);
                      $notucheck = $derow['employerboss'];
                      $sql = "select * from routes where rowner = '". $notucheck ."'";
                      $result = pg_query($conn, $sql);
