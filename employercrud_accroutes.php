...
include('aremoveowners.php');
include('acquireroutes.php');
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Name of this route</th>
                        <th>Owner of this route</th>
                        <th>Ownership request</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                            <?php if ($row['rowner'] == null) {
                                echo "Not owned by anyone yet";
                              } else {
                                echo $row['rowner'];
                              } ?>
                            </td>
                            <td class="text-center">
                              <a class="btn btn-info" href="acquireroutes.php?id=<?php echo $row['id']; ?>"><i class="fa fa-bus"></i></a>
                              <a class="btn btn-danger" href="aremoveowners.php?id2=<?php echo $row['id']; ?>"><i class="fa fa-eraser"></i></a>
